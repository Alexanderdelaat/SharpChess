...
static string BuildEmbeddedMarkdown(string notionEmbedUrl)
{
    ...
    builder.AppendLine("_disableAffix: true");
    builder.AppendLine("_disableBreadcrumb: true");
    builder.AppendLine("---");
    builder.AppendLine();
    builder.AppendLine("<div class=\"project-board-page\">");
    builder.AppendLine("  <div class=\"project-board-breakout\">");
    builder.AppendLine("    <div class=\"project-board-shell\">");
    builder.AppendLine("      <div class=\"project-board-header\">");
    builder.AppendLine("        <h1 class=\"project-board-title\">Project Board</h1>");
    ...
    builder.AppendLine("      <div class=\"project-board-frame\">");
    builder.AppendLine("        <iframe");
    builder.AppendLine($"          src=\"{escapedUrl}\"");
    builder.AppendLine("          title=\"Project Board\"");
    builder.AppendLine("          loading=\"eager\"");
