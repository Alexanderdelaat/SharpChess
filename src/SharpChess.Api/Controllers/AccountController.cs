...
public class AccountController : ControllerBase
{
    ...
    public async Task<IActionResult> UpdateEmail([FromBody] UpdateEmailRequest request, CancellationToken cancellationToken)
    {
        ...
        return result.IsFailed
            ? AuthProblemDetailsExtensions.CreateAuthProblem(this, result, StatusCodes.Status400BadRequest, "E-mailadres wijzigen mislukt.")
            : NoContent();
    }
    ...
    public async Task<IActionResult> UpdateUsername([FromBody] UpdateUsernameRequest request, CancellationToken cancellationToken)
    {
        ...
        return result.IsFailed
            ? AuthProblemDetailsExtensions.CreateAuthProblem(this, result, StatusCodes.Status400BadRequest, "Gebruikersnaam wijzigen mislukt.")
            : NoContent();
    }
    ...
    public async Task<IActionResult> UpdatePassword([FromBody] UpdatePasswordRequest request, CancellationToken cancellationToken)
    {
        ...
        return result.IsFailed
            ? AuthProblemDetailsExtensions.CreateAuthProblem(this, result, StatusCodes.Status400BadRequest, "Wachtwoord wijzigen mislukt.")
            : NoContent();
    }
}
