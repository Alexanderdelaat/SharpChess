...
_Generated at 2026-05-12 19:51 UTC._

- Namespace scope: `default`
- App label selector: not set

> Cluster access was not available when this page was generated, so no live pod snapshot could be collected.
...
```bash
K8S_NAMESPACE=default bash scripts/generate-kubernetes-pod-health.sh
```
